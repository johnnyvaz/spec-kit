...
def init(
    ...
    enhancement_lines = [
        enhancement_intro,
        "",
        f"○ [cyan]{_display_cmd('stak')}[/] [bright_black](optional)[/bright_black] - Generate executive-friendly stakeholder documentation with visual diagrams (after [cyan]/speckit.specify[/])",
