...
def init(
    ...
    enhancement_lines = [
        ...
        "",
        f"○ [cyan]/speckit.stak[/] [bright_black](optional)[/bright_black] - Generate executive-friendly stakeholder documentation with visual diagrams (after [cyan]/speckit.specify[/])",
